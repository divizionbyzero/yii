...
<div class="wrap clearfix">
    <div class="header">
        ...
        <?php else : ?>
        <div class="supernavigation clearfix">
            <span class="username"><?php echo Yii::$app->user->getIdentity()->username;?></span>

            <a class="logout" href="<?php echo Url::toRoute('site/logout');?>">Выйти</a>
        </div>
        <?php endif; ?>
    ...
    <div class="login-wrap">
        ...
        <div class="signup" ng-show="tab === 2">
            ...
            <form action="" name="signup" class="signup-form">
                ...
                <label class="clearfix">Повторите пароль<input type="password" class="input-field clearfix"
                                                               required></label>
